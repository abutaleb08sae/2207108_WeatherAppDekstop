...
public class ApiService {
    ...
    public static WeatherData fetchWeather(String city) throws Exception {
        // 1. Fetch Current Weather Data (gives us Temp, Sun times, and Lat/Lon)
        ...
        // 3. Format Sun times into human-readable format (HH:mm AM/PM)
        ...
        // 4. Map everything to our WeatherData object
    ...
    /**
     * Helper method to send HTTP requests and return a JsonNode
     */
